...
#define QT_MOC_LITERAL(ofs, len) \
  uint(offsetof(qt_meta_stringdata_draw_t, stringdata0) + ofs), len
...
void draw::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id,
                              void **_a) {
  (void)_o;
  (void)_id;
  (void)_c;
...
const QMetaObject draw::staticMetaObject = {
    {QMetaObject::SuperData::link<QOpenGLWidget::staticMetaObject>(),
     qt_meta_stringdata_draw.offsetsAndSize, qt_meta_data_draw,
     qt_static_metacall, nullptr,
     qt_incomplete_metaTypeArray<
         qt_meta_stringdata_draw_t,
